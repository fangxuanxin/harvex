...
def cmd_gen_launchd(app: App, args) -> int:
    ...
    label = args.label or "com.fxbox.harvest"
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(prog="fxharvest", description="本地数据采集框架 CLI")

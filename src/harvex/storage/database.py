...
class HarvexDatabase:
    """SQLite 数据基座，提供建表、upsert、查询、备份等完整生命周期管理。

    上下文管理器示例::

        with HarvexDatabase("jobs.db") as db:
    ...
    def __enter__(self) -> "HarvexDatabase":
        return self
    ...
    def __repr__(self) -> str:
        return f"HarvexDatabase({self._path!r})"


__all__ = ["HarvexDatabase"]

...
# 内部标记：防止重复添加 handler
_SETUP_DONE_ATTR = "_harvex_setup_done"
...
def setup_logging(
    ...
    *,
    ...
    Args:
        log_dir: 日志目录。若提供，则在该目录下创建 harvex.log 文件，
    ...
    if log_dir is not None:
        ...
        log_file = os.path.join(log_dir_path, "harvex.log")
...
def get_logger(
    ...
    *,
    ...
    Example::
        ...
        logger.info("开始抓取")
        # 输出：2024-01-01 12:00:00 | INFO     | harvex | 开始抓取  [run=42 source=icbc]
    """
